...
router.post('/decrypt', async (req, res) => {
    try {
        console.log(req.body);
            // var decrypt = cryptoJS.AES.decrypt(req.body, process.env.QR_HASH_KEY).toString(cryptoJS.enc.Utf8);
        ...
        const invoice = await Invoice.findOneAndUpdate(
            {_id: req.params.userid, "businessName._id": req.params.vendorid, "businessName.invoices._id": mongoose.Types.ObjectId(req.params.invoiceid)},
            {
                $set: {
                    ...
                    "businessName.$[d].invoices.$[o].roundoff": req.body.invoices.roundoff,
                    ...
                    "businessName.$[d].invoices.$[o].invoicePaymentMode": req.body.invoices.invoicePaymentMode,
