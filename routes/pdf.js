  ...
  try {
    const invoice = await Invoice.aggregate([
      ...
      doc
        .fontSize(23)
        .font("Helvetica")
        .text(invoice[0].invoices.invoiceTitle.toUpperCase(), {
          underline: true,
        });
      ...
      doc
        .fontSize(12)
        .font("Helvetica")
        .text("Address: " + invoice[0].invoices.businessAddress, {
          align: "left",
        });
      ...
      doc
        .fontSize(12)
        .font("Helvetica")
        .text("Business ID: " + req.params.vendorId, {
          align: "left",
        });
      ...
      doc
        .fontSize(12)
        .text("Contact No.: " + invoice[0].invoices.businessContactNo, {
          align: "left",
        });
      ...
      doc
        .fontSize(12)
        .text("Invoice No.: " + invoice[0].invoices.invoiceNumber);
      ...
      doc
        .fontSize(12)
        .font("Helvetica")
        .text(`Total: ` + invoice[0].invoices.invoiceAmount, {
          align: "right",
        });
      ...
      doc
        .fontSize(12)
        .font("Helvetica")
        .text("Discount: " + invoice[0].invoices.discount + "%", {
          align: "left",
        });
      ...
      doc
        .fontSize(12)
        .font("Helvetica")
        .text("Net Total: " + invoice[0].invoices.roundoff, {
          align: "right",
        });
      ...
      doc
        .fontSize(12)
        .font("Helvetica")
        .text("Payment Method: " + invoice[0].invoices.invoicePaymentMode, {
          align: "left",
        });
      ...
      doc
        .fontSize(12)
        .font("Helvetica")
        .text(invoice[0].invoices.invoiceDescription, {
          align: "Center",
        });
